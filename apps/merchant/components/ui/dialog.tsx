  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // max-h + overflow: the dialog is centred and had no height bound, so
          // on a short window its title and its buttons fell outside the
          // viewport with nothing to scroll — the confirm button became
