export const en = {
  ...
  landing: {
    ...
    selfCustody: "Withdraw whenever you want",
    selfCustodyDesc: "Your balance goes to whichever address you choose, without asking anyone",
  },
  dashboard: {
    title: "Dashboard",
    subtitle: "Overview of your balances and activity",
    totalBalance: "Balance in Voulti",
    refresh: "Refresh",
    balances: "Payments to withdraw",
    ...
    yourWalletDesc: "The address Voulti created for you. Anything sent straight here does not go through Voulti and does not show above.",
    copy: "Copy",
    networks: "networks",
  },
  receive: {
  ...
  send: {
    ...
    gasUnknown: "We couldn't check your wallet's {native} balance right now, so we'll withdraw with no fee. If the wallet has no {native} for gas, the transaction will fail — send it a small amount and try again.",
