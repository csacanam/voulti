export const es = {
  ...
  landing: {
    ...
    selfCustody: "Retirás cuando quieras",
    selfCustodyDesc: "Tu saldo sale a la dirección que elijas, sin pedirle permiso a nadie",
  },
  dashboard: {
    title: "Dashboard",
    subtitle: "Resumen de tus saldos y actividad",
    totalBalance: "Saldo en Voulti",
    refresh: "Actualizar",
    balances: "Cobros por retirar",
    ...
    yourWalletDesc: "La dirección que Voulti creó para vos. Lo que te manden directo acá no pasa por Voulti y no aparece arriba.",
    copy: "Copiar",
    networks: "redes",
  },
  receive: {
  ...
  send: {
    ...
    withdraw: "Retirar",
    needsGas: "Esta wallet necesita un poco de {native} para pagar la transacción. Mándale un poco a la dirección de abajo y vuelve a retirar.",
  ...
  dev: {
    ...
    s3Null: "En los dos últimos los campos de pago llegan en null. Si tu servidor no responde 2xx en 2 s reintentamos con espera creciente —1m, 5m, 30m, 2h, 6h, 12h, 24h: 8 intentos en unos dos días—, así que tu handler tiene que ser idempotente.",
  ...
  webhookTest: {
    ...
    paidButUndelivered: "El cobro se pagó, pero tu servidor todavía no confirmó la notificación. El dinero está; el aviso no llegó.",
    undelivered: "Tu servidor todavía no confirmó esta notificación.",
    attemptsSoFar: "Llevamos {n} intentos.",
  ...
  networks: {
    title: "Redes",
    subtitle: "Activa o desactiva redes para aceptar pagos",
    active: "Activa",
    inactive: "Inactiva",
    ...
    enable: "Activar",
    disable: "Desactivar",
    loadFailed: "No se pudieron cargar las redes",
    updateFailed: "No se pudo actualizar la red",
    enabled: "{network} activada",
    disabled: "{network} desactivada",
  },
  payoutDetail: {
    title: "Detalle del Envío",
    unknownStatus: "Desconocido",
    amountTransferred: "Monto Transferido",
    toRecipient: "al destinatario",
    email: "Email",
    wallet: "Dirección de Wallet",
    ...
    receiptId: "ID",
    receiptDate: "Fecha",
    receiptRecipient: "Destinatario",
    receiptEmail: "Email",
    receiptWallet: "Wallet",
    receiptAmount: "Monto",
    receiptLocalAmount: "Monto Local",
    receiptStatus: "Estado",
    receiptTxHash: "Hash TX",
  },
  footer: {
    // Split around the Saka Labs link, which stays a link in both languages.
    productPrefix: "Un producto de",
    productSuffix: "",
    builtBy: "Hecho por",
  },
  code: {
