              ...
              <div className="text-center">
                ...
                >
                  <span className="text-2xl font-bold text-gray-900 break-all">
                    {deposit.expectedAmount.replace(/\.?0+$/, '') || '0'}
                  </span>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <>{t.payByAddress.checkAmount} <strong className="text-gray-900">{deposit.expectedAmount.replace(/\.?0+$/, '') || '0'} {deposit.tokenSymbol}</strong></>,
                  ].map((item, i) => (
